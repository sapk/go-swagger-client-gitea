...
type OrgDeleteMemberNoContent struct {
	Payload OrgDeleteMemberNoContentBody
}

func (o *OrgDeleteMemberNoContent) Error() string {
	return fmt.Sprintf("[DELETE /orgs/{org}/members/{username}][%d] orgDeleteMemberNoContent  %+v", 204, o.Payload)
}
...
/*OrgDeleteMemberNoContentBody APIEmpty is an empty response
swagger:model OrgDeleteMemberNoContentBody
*/
type OrgDeleteMemberNoContentBody interface{}
