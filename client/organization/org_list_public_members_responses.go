...
type OrgListPublicMembersOK struct {
	Payload []*models.OrgListPublicMembersOKBodyItems0
}
...
/*OrgListPublicMembersOKBodyItems0 User represents a user
swagger:model OrgListPublicMembersOKBodyItems0
*/
type OrgListPublicMembersOKBodyItems0 struct {
...
// Validate validates this org list public members o k body items0
func (o *OrgListPublicMembersOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *OrgListPublicMembersOKBodyItems0) validateEmail(formats strfmt.Registry) error {
...
func (o *OrgListPublicMembersOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *OrgListPublicMembersOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res OrgListPublicMembersOKBodyItems0
