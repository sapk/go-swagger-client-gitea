...
type OrgPublicizeMemberNoContent struct {
	Payload OrgPublicizeMemberNoContentBody
}

func (o *OrgPublicizeMemberNoContent) Error() string {
	return fmt.Sprintf("[PUT /orgs/{org}/public_members/{username}][%d] orgPublicizeMemberNoContent  %+v", 204, o.Payload)
}
...
/*OrgPublicizeMemberNoContentBody APIEmpty is an empty response
swagger:model OrgPublicizeMemberNoContentBody
*/
type OrgPublicizeMemberNoContentBody interface{}
