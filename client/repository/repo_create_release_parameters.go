...
func (o *RepoCreateReleaseParams) WithBody(body RepoCreateReleaseBody) *RepoCreateReleaseParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the repo create release params
func (o *RepoCreateReleaseParams) SetBody(body RepoCreateReleaseBody) {
	o.Body = body
}
