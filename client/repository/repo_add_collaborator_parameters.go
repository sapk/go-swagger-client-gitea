...
func (o *RepoAddCollaboratorParams) WithBody(body RepoAddCollaboratorBody) *RepoAddCollaboratorParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the repo add collaborator params
func (o *RepoAddCollaboratorParams) SetBody(body RepoAddCollaboratorBody) {
	o.Body = body
}
