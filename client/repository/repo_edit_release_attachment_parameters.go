...
func (o *RepoEditReleaseAttachmentParams) WithBody(body RepoEditReleaseAttachmentBody) *RepoEditReleaseAttachmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the repo edit release attachment params
func (o *RepoEditReleaseAttachmentParams) SetBody(body RepoEditReleaseAttachmentBody) {
	o.Body = body
}
