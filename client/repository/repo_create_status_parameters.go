...
func (o *RepoCreateStatusParams) WithBody(body RepoCreateStatusBody) *RepoCreateStatusParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the repo create status params
func (o *RepoCreateStatusParams) SetBody(body RepoCreateStatusBody) {
	o.Body = body
}
