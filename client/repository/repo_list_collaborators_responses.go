...
type RepoListCollaboratorsOK struct {
	Payload []*models.RepoListCollaboratorsOKBodyItems0
}
...
/*RepoListCollaboratorsOKBodyItems0 User represents a user
swagger:model RepoListCollaboratorsOKBodyItems0
*/
type RepoListCollaboratorsOKBodyItems0 struct {
...
// Validate validates this repo list collaborators o k body items0
func (o *RepoListCollaboratorsOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *RepoListCollaboratorsOKBodyItems0) validateEmail(formats strfmt.Registry) error {
...
func (o *RepoListCollaboratorsOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *RepoListCollaboratorsOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res RepoListCollaboratorsOKBodyItems0
