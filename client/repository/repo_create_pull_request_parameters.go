...
func (o *RepoCreatePullRequestParams) WithBody(body RepoCreatePullRequestBody) *RepoCreatePullRequestParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the repo create pull request params
func (o *RepoCreatePullRequestParams) SetBody(body RepoCreatePullRequestBody) {
	o.Body = body
}
