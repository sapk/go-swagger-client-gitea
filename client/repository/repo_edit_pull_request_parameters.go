...
func (o *RepoEditPullRequestParams) WithBody(body RepoEditPullRequestBody) *RepoEditPullRequestParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the repo edit pull request params
func (o *RepoEditPullRequestParams) SetBody(body RepoEditPullRequestBody) {
	o.Body = body
}
