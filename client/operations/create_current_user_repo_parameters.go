...
func (o *CreateCurrentUserRepoParams) WithBody(body CreateCurrentUserRepoBody) *CreateCurrentUserRepoParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create current user repo params
func (o *CreateCurrentUserRepoParams) SetBody(body CreateCurrentUserRepoBody) {
	o.Body = body
}
