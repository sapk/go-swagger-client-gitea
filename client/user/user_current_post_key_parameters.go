...
func (o *UserCurrentPostKeyParams) WithBody(body UserCurrentPostKeyBody) *UserCurrentPostKeyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user current post key params
func (o *UserCurrentPostKeyParams) SetBody(body UserCurrentPostKeyBody) {
	o.Body = body
}
