...
type UserListFollowingOK struct {
	Payload []*models.UserListFollowingOKBodyItems0
}
...
/*UserListFollowingOKBodyItems0 User represents a user
swagger:model UserListFollowingOKBodyItems0
*/
type UserListFollowingOKBodyItems0 struct {
...
// Validate validates this user list following o k body items0
func (o *UserListFollowingOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *UserListFollowingOKBodyItems0) validateEmail(formats strfmt.Registry) error {
...
func (o *UserListFollowingOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *UserListFollowingOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res UserListFollowingOKBodyItems0
