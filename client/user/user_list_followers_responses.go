...
type UserListFollowersOK struct {
	Payload []*models.UserListFollowersOKBodyItems0
}
...
/*UserListFollowersOKBodyItems0 User represents a user
swagger:model UserListFollowersOKBodyItems0
*/
type UserListFollowersOKBodyItems0 struct {
...
// Validate validates this user list followers o k body items0
func (o *UserListFollowersOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *UserListFollowersOKBodyItems0) validateEmail(formats strfmt.Registry) error {
...
func (o *UserListFollowersOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *UserListFollowersOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res UserListFollowersOKBodyItems0
