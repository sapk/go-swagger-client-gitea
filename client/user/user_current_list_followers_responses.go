...
type UserCurrentListFollowersOK struct {
	Payload []*models.UserCurrentListFollowersOKBodyItems0
}
...
/*UserCurrentListFollowersOKBodyItems0 User represents a user
swagger:model UserCurrentListFollowersOKBodyItems0
*/
type UserCurrentListFollowersOKBodyItems0 struct {
...
// Validate validates this user current list followers o k body items0
func (o *UserCurrentListFollowersOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *UserCurrentListFollowersOKBodyItems0) validateEmail(formats strfmt.Registry) error {
...
func (o *UserCurrentListFollowersOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *UserCurrentListFollowersOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res UserCurrentListFollowersOKBodyItems0
