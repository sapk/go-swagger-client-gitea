...
type UserCurrentListFollowingOK struct {
	Payload []*models.UserCurrentListFollowingOKBodyItems0
}
...
/*UserCurrentListFollowingOKBodyItems0 User represents a user
swagger:model UserCurrentListFollowingOKBodyItems0
*/
type UserCurrentListFollowingOKBodyItems0 struct {
...
// Validate validates this user current list following o k body items0
func (o *UserCurrentListFollowingOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *UserCurrentListFollowingOKBodyItems0) validateEmail(formats strfmt.Registry) error {
...
func (o *UserCurrentListFollowingOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *UserCurrentListFollowingOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res UserCurrentListFollowingOKBodyItems0
