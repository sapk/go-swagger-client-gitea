...
type UserCurrentTrackedTimesOK struct {
	Payload []*models.UserCurrentTrackedTimesOKBodyItems0
}
...
/*UserCurrentTrackedTimesOKBodyItems0 TrackedTime worked time for an issue / pr
swagger:model UserCurrentTrackedTimesOKBodyItems0
*/
type UserCurrentTrackedTimesOKBodyItems0 struct {
...
// Validate validates this user current tracked times o k body items0
func (o *UserCurrentTrackedTimesOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *UserCurrentTrackedTimesOKBodyItems0) validateCreated(formats strfmt.Registry) error {
...
func (o *UserCurrentTrackedTimesOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *UserCurrentTrackedTimesOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res UserCurrentTrackedTimesOKBodyItems0
