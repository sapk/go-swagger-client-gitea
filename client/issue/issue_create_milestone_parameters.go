...
func (o *IssueCreateMilestoneParams) WithBody(body IssueCreateMilestoneBody) *IssueCreateMilestoneParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the issue create milestone params
func (o *IssueCreateMilestoneParams) SetBody(body IssueCreateMilestoneBody) {
	o.Body = body
}
