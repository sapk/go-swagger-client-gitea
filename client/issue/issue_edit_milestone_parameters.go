...
func (o *IssueEditMilestoneParams) WithBody(body IssueEditMilestoneBody) *IssueEditMilestoneParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the issue edit milestone params
func (o *IssueEditMilestoneParams) SetBody(body IssueEditMilestoneBody) {
	o.Body = body
}
