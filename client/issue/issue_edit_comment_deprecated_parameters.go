...
func (o *IssueEditCommentDeprecatedParams) WithBody(body IssueEditCommentDeprecatedBody) *IssueEditCommentDeprecatedParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the issue edit comment deprecated params
func (o *IssueEditCommentDeprecatedParams) SetBody(body IssueEditCommentDeprecatedBody) {
	o.Body = body
}
