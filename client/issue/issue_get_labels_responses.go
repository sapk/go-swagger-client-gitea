...
type IssueGetLabelsOK struct {
	Payload []*models.IssueGetLabelsOKBodyItems0
}
...
/*IssueGetLabelsOKBodyItems0 Label a label to an issue or a pr
swagger:model IssueGetLabelsOKBodyItems0
*/
type IssueGetLabelsOKBodyItems0 struct {
...
// Validate validates this issue get labels o k body items0
func (o *IssueGetLabelsOKBodyItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *IssueGetLabelsOKBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *IssueGetLabelsOKBodyItems0) UnmarshalBinary(b []byte) error {
	var res IssueGetLabelsOKBodyItems0
