...
func (o *IssueReplaceLabelsParams) WithBody(body IssueReplaceLabelsBody) *IssueReplaceLabelsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the issue replace labels params
func (o *IssueReplaceLabelsParams) SetBody(body IssueReplaceLabelsBody) {
	o.Body = body
}
