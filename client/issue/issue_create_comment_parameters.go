...
func (o *IssueCreateCommentParams) WithBody(body IssueCreateCommentBody) *IssueCreateCommentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the issue create comment params
func (o *IssueCreateCommentParams) SetBody(body IssueCreateCommentBody) {
	o.Body = body
}
