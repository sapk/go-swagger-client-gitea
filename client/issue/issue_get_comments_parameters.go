...
// WithString adds the string to the issue get comments params
func (o *IssueGetCommentsParams) WithString(string *string) *IssueGetCommentsParams {
	o.SetString(string)
	return o
}

// SetString adds the string to the issue get comments params
func (o *IssueGetCommentsParams) SetString(string *string) {
	o.String = string
}
