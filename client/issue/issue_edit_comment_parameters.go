...
func (o *IssueEditCommentParams) WithBody(body IssueEditCommentBody) *IssueEditCommentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the issue edit comment params
func (o *IssueEditCommentParams) SetBody(body IssueEditCommentBody) {
	o.Body = body
}
