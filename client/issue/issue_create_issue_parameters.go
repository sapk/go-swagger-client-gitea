...
func (o *IssueCreateIssueParams) WithBody(body IssueCreateIssueBody) *IssueCreateIssueParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the issue create issue params
func (o *IssueCreateIssueParams) SetBody(body IssueCreateIssueBody) {
	o.Body = body
}
