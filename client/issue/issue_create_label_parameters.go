...
func (o *IssueCreateLabelParams) WithBody(body IssueCreateLabelBody) *IssueCreateLabelParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the issue create label params
func (o *IssueCreateLabelParams) SetBody(body IssueCreateLabelBody) {
	o.Body = body
}
